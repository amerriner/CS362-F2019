...
int main() {
	...
	printf("\nTest 1: Choice1 = silver, choice2 = gold: Golden Path Correct Card Swap\n");
	...
	int result = mineRefactor(currentPlayer, &testG, choice1, choice2, handPos);
	discarded = 2;
	...
	choice2 = gold;
	memcpy(&testG, &G, sizeof(struct gameState));
	result = mineRefactor(currentPlayer, &testG, choice1, choice2, handPos);
	...
	printf("\nTest 3: Choice1 = silver, Choice2 = baron: Choice2 not a treasure card\n");
