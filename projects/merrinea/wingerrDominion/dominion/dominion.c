...
//refactored code from cardEffect switch function
...
int minionRefactor(int currentPlayer, struct gameState* state, int choice1, int choice2, int handPos) {
	//+1 action
	state->numActions++;
	int i, j;
...
int ambassadorRefactor(int currentPlayer, struct gameState* state, int choice1, int choice2, int handPos) {
...
int tributeRefactor(int currentPlayer, struct gameState* state, int nextPlayer) {
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case baron:
		baronRefactor(currentPlayer, state, choice1);
        return 0;
    ...
    case minion:
		minionRefactor(currentPlayer, state, choice1, choice2, handPos);
        return 0;
    ...
    case tribute:
		tributeRefactor(currentPlayer, state, nextPlayer);
        return 0;

    case ambassador:
		ambassadorRefactor(currentPlayer, state, choice1, choice2, handPos);
        return 0;
